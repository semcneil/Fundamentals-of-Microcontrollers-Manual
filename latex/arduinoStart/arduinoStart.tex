...
\begin{figure}[!htb]
	...
	\includegraphics[width=\textwidth]{arduinoStart/Schematic_NanoConnectRP2040testv0.3} % leaving off extension seems to work
...
\begin{figure}[!htb]
	\centering
	\includegraphics[scale=0.8]{arduinoStart/PCB_NanoConnectRP2040test1v0.3} % leaving off extension seems to work
